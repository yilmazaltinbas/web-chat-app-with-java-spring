package com.bitirmeprojesi.chatapplication.jjj;


import com.bitirmeprojesi.chatapplication.ChatMessagePojo;
...
public class WebSocketEventListener {
    ...
    public void handleWebSocketConnectListener(SessionConnectedEvent event) {
        logger.info("Yeni bir web soket bağlantısı alındı");
    }
